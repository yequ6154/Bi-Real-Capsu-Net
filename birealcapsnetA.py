...
class Attention(nn.Module):
    def __init__(self, h, w, ch_i, n_i, ch_j, n_j):
        super().__init__()
        self.ch_i = ch_i
        self.n_i = n_i
        self.ch_j = ch_j
...
class Model(nn.Module):
    def __init__(self):
        ...
        self.attention1 = Attention(h=4, w=4, ch_i=32, n_i=8, ch_j=32, n_j=8)
        ...
        self.attention2 = Attention(h=2, w=2, ch_i=32, n_i=8, ch_j=32, n_j=8)
